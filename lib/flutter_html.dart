...
class Html extends StatelessWidget {
  ...
  /// Define show full html or display button show more
  final bool? isShowFull;

  /// Define number character display seemore
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: HtmlParser(
        ...
        isShowFull: isShowFull ?? false,
        numberShortCharacterDisplay: numberShortCharacterDisplay,
      ),
    );
  }
}
